...
#PINTOOL="/Users/tshull7/UIUC/CS598DHP/project/parallel_trace_generator/obj-intel64/GCTracer.dylib"
...
#$PIN  -t $PINTOOL -mfs -cs -c $CACHE_SIZE -l $CACHE_LINE_SIZE -a $CACHE_ASSOCIATIVITY -- ls .
...
$PIN  -t $PINTOOL -mfs -at -cs -c $CACHE_SIZE -l $CACHE_LINE_SIZE -a $CACHE_ASSOCIATIVITY -o pinlog.log -- ls .
